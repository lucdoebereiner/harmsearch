          ...
          (\fingeringPairs ->
             let vcs = map fst fingeringPairs
              ...
              in S.allDifferent vcs &&
                 ...
                 S.inWindow 2 (any (H.isNatMultiphonic . snd)) vcs &&
                 S.inWindow 2 (any (H.isNatMultiphonic . snd)) dbs &&
                 -- S.inWindow 4 (any (H.isHalfHarm . snd)) vcs &&
                 -- S.inWindow 4 (any (H.isHalfHarm . snd)) dbs &&
                 H.psetPredPair
